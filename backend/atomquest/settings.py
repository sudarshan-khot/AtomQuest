"""
Django settings for atomquest project.

This module contains configuration for both development and production environments.
Environment-specific settings are applied based on the DEBUG flag and environment variables.
"""
